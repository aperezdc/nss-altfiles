...
/* Unlike in nss_files which shares code with nss_db this library should
 * never export symbols generated by LINE_PARSER() but it still may refer
 * to _nss_files_parse_* functions defined in glibc's pwd and grp modules.
 */
#ifndef EXTERN_PARSER
