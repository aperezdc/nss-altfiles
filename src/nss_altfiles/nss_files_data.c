...
#define __libc_lock_init(_) ((void) 0)
#define __libc_lock_lock(_) ((void) 0)
#define __libc_lock_unlock(_) ((void) 0)
...
static struct nss_files_data nss_files_global = { { { NULL } }, };
...
{
  struct nss_files_data *data = &nss_files_global;
